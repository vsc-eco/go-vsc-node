...
// share, the pendulum.DefaultLPFloorBps LP minimum-floor (gated on consensus
// pendulum.LPFloorActivation — inert until that line is chain-active), the CLP
// slip leg scaled to 1/16 with m off it, and a 1% total-fee clamp. Override
