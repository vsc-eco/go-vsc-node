...
type Transactions interface {
	...
	FindTransactions(id *string, account *string, status *string, contract *string, byType *string, ledgerToFrom *string, ledgerTypes []string, offset int, limit int) ([]TransactionRecord, error)
